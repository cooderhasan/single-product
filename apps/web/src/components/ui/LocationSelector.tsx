    ...
    <div className="w-full">
      ...
      <div className="relative group">
        ...
        <select
          ...
          disabled={isDisabled}
          className={cn(
            "w-full appearance-none bg-white border-2 border-slate-200 rounded-2xl py-4 pl-12 pr-10 text-sm font-medium focus:outline-none focus:ring-0 focus:border-primary-600 transition-all duration-200 cursor-pointer hover:border-slate-300 shadow-sm",
